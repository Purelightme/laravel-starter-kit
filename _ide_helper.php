 ...
 * Generated for Laravel 5.5.43 on 2018-09-27 21:34:20.
 *
...
namespace Yansongda\LaravelPay\Facades { 
    ...
    class Pay {
         ...
         * @static 
         */ 
        public static function verify($content = null, $refund = false)
        {
            return \Yansongda\Pay\Gateways\Alipay::verify($content, $refund);
        }
         ...
         * @static 
         */ 
        public static function find($order, $refund = false)
        {
            return \Yansongda\Pay\Gateways\Alipay::find($order, $refund);
        }
